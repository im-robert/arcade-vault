...
import type { RecentScoreEntry, TopPlayerEntry } from "@/lib/scores";
              ...
              {recentScores.length === 0 ? (
                ...
                >
                  ...
                  <div style={{ fontSize: 12 }}>
                    Todavía no hay puntuaciones registradas. Juega y aparece
                    aquí.
                  </div>
                </div>
              ) : (
            ...
            <div className="top-list">
              {topPlayers.length === 0 ? (
                ...
                >
                  ...
                  >
                    ¡ESTE RANKING TE ESPERA!
                  </div>
                  <div style={{ fontSize: 12 }}>
                    Nadie ha entrado todavía. Juega una partida y sé el primer
                    nombre en la lista.
                  </div>
                </div>
              ) : (
                topPlayers.map((r, i) => (
                  ...
                  >
                    ...
                    <span className="tp-s">
                      {r.totalScore.toLocaleString("es-ES")}
                    </span>
                  </div>
                ))
              )}
